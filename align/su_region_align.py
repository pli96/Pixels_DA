...
def getRegionList(): # file interface
    site_file = "/OceanStor100D/home/lichengyu_lab/lipy/neuropixel/meta/NP tracks validated3.3.csv"
...
def gen_align_files(cmp=False):
    ...
    for path in futil.traverse("/OceanStor100D/home/lichengyu_lab/lipy/neuropixel/DataSum"):
        su_region_corr = []
        print(path)
